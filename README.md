...
[![CI](https://github.com/step-security/pull-request-comment-branch/actions/workflows/ci.yml/badge.svg?branch=main)](https://github.com/step-security/pull-request-comment-branch/actions/workflows/ci.yml)
...
jobs:
  pr-comment:
    ...
    steps:
      - uses: step-security/pull-request-comment-branch@v3
        id: comment-branch
